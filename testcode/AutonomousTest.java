...
public class AutonomousTest extends LinearOpMode {
    ...
    final double markerOpen = 0;
    final double markerClose = (double) 115 / 180;
    ...
    private void driveDist(double dist) {
        ...
        while (isMotorsBusy() && opModeIsActive()) {
            ...
            if (backLeft.getCurrentPosition() >= backLeft.getTargetPosition() * (double) 3/4) {
                drive(DRIVE_SPEED * 0.5, 0, 0);
            }*/
