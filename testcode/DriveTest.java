    ...
    public void runOpMode() {
        ...
        while(opModeIsActive()) {
            ...
            if (gamepad2.y && !db2.equals("y")) {
                ...
                db2 = "y";
            } else if (!gamepad1.y && db2.equals("y")) {
                db2 = "";
            }
            ...
            boolean bumpersPressed = gamepad2.left_bumper && gamepad2.right_bumper;
            if (Math.abs(armPower) >= 0.5 && !bumpersPressed) {
                // If the arm power is positive, set it to 0.5, else if it's negative, set it to -0.5
                armPower = armPower >= 0 ? 0.5 : -0.5;
